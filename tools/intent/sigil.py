...
def cmd_demo(args) -> int:
    ...
    try:
        ...
        print(f"  Viewer: {url}")
        print()
        print(f"  ⛔ PR #47 is currently blocked — GATE-0005 caught raw card access in checkout.py")
        print(f"     Press w to see exactly what sigil-bot posts on the PR")
        print()
        print(f"  Explorer shortcuts:")
        print(f"    w  Review       — PR gate enforcement (start here)")
